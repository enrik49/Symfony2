...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'jamab.infosender' => 'getJamab_InfosenderService',
            'jamab.model' => 'getJamab_ModelService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'alimentos', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_2819c32ae0e0120749394cb81a7f2550');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_2819c32ae0e0120749394cb81a7f2550');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_2819c32ae0e0120749394cb81a7f2550');
    ...
    /**
     * Gets the 'jamab.infosender' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Jazzyweb\AulasMentor\AlimentosBundle\Services\InfoSender A Jazzyweb\AulasMentor\AlimentosBundle\Services\InfoSender instance.
     */
    protected function getJamab_InfosenderService()
    {
        return $this->services['jamab.infosender'] = new \Jazzyweb\AulasMentor\AlimentosBundle\Services\InfoSender($this->get('jamab.model'), $this->get('swiftmailer.mailer.default'));
    }

    /**
     * Gets the 'jamab.model' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Jazzyweb\AulasMentor\AlimentosBundle\Model\Model A Jazzyweb\AulasMentor\AlimentosBundle\Model\Model instance.
     */
    protected function getJamab_ModelService()
    {
        return $this->services['jamab.model'] = new \Jazzyweb\AulasMentor\AlimentosBundle\Model\Model('alimentos', 'root', NULL, '127.0.0.1');
    }
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('xxxchiribillo@gmail.com');
        $a->setPassword('giribet');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Jazzyweb\\AulasMentor\\AlimentosBundle/Resources/views'), 'JazzywebAulasMentorAlimentos');
        $instance->addPath(($this->targetDirs[3].'\\fuentes\\Unidad3\\EjercicosBundle/Resources/views'), 'Unidad3Ejercicos');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'Unidad3EjercicosBundle' => 'Unidad3\\EjercicosBundle\\Unidad3EjercicosBundle',
            ...
            'port' => 465,
            'encryption' => 'ssl',
            'mailer_user' => 'xxxchiribillo@gmail.com',
            'mailer_password' => 'giribet',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'xxxchiribillo@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'giribet',
