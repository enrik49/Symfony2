...
class appPruDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_999ee530fffbdcc3775d746bc6b6c150');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_999ee530fffbdcc3775d746bc6b6c150');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_999ee530fffbdcc3775d746bc6b6c150');
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler(($this->targetDirs[2].'\\logs/pru.log'), 100, true);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'debug.container.dump' => (__DIR__.'/appPruDebugProjectContainer.xml'),
